...
## Give Techtree to your Hermes agent

Paste this into Hermes:

> Read the pinned Hello World installation instructions at techtree.sh/start.
...
component — or by asking the installed CLI what release it belongs to:
...
That is the whole plugin component: what the plugin is, and nothing about how it
...
the attacks they catch, while this component remains the directory an
...
It reads the plugin directly from the adjacent `plugin/` component in this
monorepo.
