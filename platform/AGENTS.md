...
- LiveView streams *do not support counting or empty states*. If you need to display a count, you must track it using a separate assign. For empty states, use semantic markup and existing CSS classes:
