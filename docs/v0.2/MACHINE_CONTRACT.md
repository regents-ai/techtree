...
| `proof.verify` | `techtree.cli.commands.proof:verify_proof_command` | `techtree.cli.commands.forge:verify_forge_command` | Whether the stored bytes verify offline. |
